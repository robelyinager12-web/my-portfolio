...
const socialColors = {
  github: 'hover:text-neon-cyan hover:shadow-[0_0_12px_rgba(0,255,255,0.4)]',
  linkedin: 'hover:text-neon-violet hover:shadow-[0_0_12px_rgba(139,92,246,0.4)]',
  email: 'hover:text-neon-pink hover:shadow-[0_0_12px_rgba(236,72,153,0.4)]',
  twitter: 'hover:text-neon-cyan hover:shadow-[0_0_12px_rgba(0,255,255,0.4)]',
  telegram: 'hover:text-neon-violet hover:shadow-[0_0_12px_rgba(139,92,246,0.4)]'
};
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div className="space-y-4">
              ...
              href="#home"
              className={cn(
                'inline-block font-display text-2xl font-bold',
          ...
          <div className="space-y-4">
            <h3 className="font-mono text-xs text-neon-cyan tracking-widest uppercase">
              Navigation
            </h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <p className="font-mono text-xs text-text-muted">
              <span className="text-neon-cyan">{site.location}</span>
              {' '}{site.locationFlag}
            </p>
