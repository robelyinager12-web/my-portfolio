...
const TECH_LABELS = [
  ...
  'MongoDB', 'PostgreSQL', 'Three.js', 'Docker',
  'AWS', 'GraphQL', 'Redis', 'Express'
];
  ...
  const orbitingShapes = useMemo(() => [
    {
      ...
      orbitOffset: 0,
      scale: 1,
      rotationSpeed: [0.01, 0.015, 0.005] as [number, number, number]
    },
    {
      geometry: new THREE.TorusGeometry(0.25, 0.08, 6, 12),
      color: SHAPE_COLORS[1],
      orbitRadius: 5.0,
      orbitSpeed: 0.3,
      orbitOffset: Math.PI * 0.4,
      scale: 1,
      rotationSpeed: [0.02, 0.01, 0.015] as [number, number, number]
    },
    {
      ...
      scale: 1,
      rotationSpeed: [0.008, 0.02, 0.012] as [number, number, number]
    },
    {
      ...
      scale: 1,
      rotationSpeed: [0.015, 0.008, 0.02] as [number, number, number]
    },
    {
      geometry: new THREE.TetrahedronGeometry(0.32, 0),
      color: SHAPE_COLORS[4],
      orbitRadius: 4.8,
      orbitSpeed: 0.35,
      orbitOffset: Math.PI * 1.6,
      scale: 1,
      rotationSpeed: [0.012, 0.018, 0.006] as [number, number, number]
    }
  ], []);
